...
service](http://ncbi.nlm.nih.gov/pmc/tools/oa-service/).  Point your browser at
[http://pubmedcentral.nih.gov/utils/oa/oa.fcgi?id=PMC2873961](), and look for the link with
format `tgz`.
